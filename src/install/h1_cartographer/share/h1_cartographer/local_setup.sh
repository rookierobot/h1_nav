...
: ${AMENT_CURRENT_PREFIX:="/home/robot/nav2_ws/src/install/h1_cartographer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/h1_cartographer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/h1_cartographer/environment/path.sh"
