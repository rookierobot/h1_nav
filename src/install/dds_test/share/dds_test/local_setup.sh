...
: ${AMENT_CURRENT_PREFIX:="/home/robot/nav2_ws/src/install/dds_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dds_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dds_test/environment/path.sh"
