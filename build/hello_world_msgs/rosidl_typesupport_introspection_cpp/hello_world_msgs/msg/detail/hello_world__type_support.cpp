...
{
  new (message_memory) hello_world_msgs::msg::HelloWorld(_init);
}

void HelloWorld_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hello_world_msgs::msg::HelloWorld *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HelloWorld_message_member_array[2] = {
  {
    ...
    offsetof(hello_world_msgs::msg::HelloWorld, userid),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hello_world_msgs::msg::HelloWorld, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HelloWorld_message_members = {
  "hello_world_msgs::msg",  // message namespace
  "HelloWorld",  // message name
  2,  // number of fields
  sizeof(hello_world_msgs::msg::HelloWorld),
...
{
  return &::hello_world_msgs::msg::rosidl_typesupport_introspection_cpp::HelloWorld_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hello_world_msgs, msg, HelloWorld)() {
  return &::hello_world_msgs::msg::rosidl_typesupport_introspection_cpp::HelloWorld_message_type_support_handle;
}
